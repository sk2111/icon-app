...
//actions
import { setProjectIconsTabProjectsSearchValue } from '../../../redux/project-icons/project-icons.actions';
...
const mapDispatchToProps = (dispatch) => {
    return {
        setSearchValue: (searchValue) => dispatch(setProjectIconsTabProjectsSearchValue(searchValue)),
